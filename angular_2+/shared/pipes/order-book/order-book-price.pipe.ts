...
export class OrderBookPricePipe extends OrderBookBasePipe implements PipeTransform {
  maxLength = 8;
  ...
  transform(value: any, args?: any): any {
    ...
    const fractionPartLength = (integerPart.length > 1) ? 2 : this.maxLength - integerPart.length;
